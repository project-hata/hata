...
module Verification.Core.Theory.FirstOrderTerm.Unification.PCF.Size where
...
module _ {Σ : FOSignature 𝑖} where
  ...
  instance
    isSizedHomPairCategory:𝐂𝐭𝐱-𝕋× : isSizedHomPairCategory (⧜𝐒𝐮𝐛𝐬𝐭 (term-FO Σ))
